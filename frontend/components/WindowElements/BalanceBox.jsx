...
const BalanceBox = () => {
  ...
  return (
    <Box className="flex flex-col justify-between w-1/2 p-5 bg-white rounded-3xl space-y-5 overflow-clip">
      ...
      <p className="text-5xl font-bold text-purple-800">$123,000</p>
      <p className="text-slate-400">April 12, 2022 • 12:19 PM</p>
      <Box
        className={`flex flex-row justify-center items-center self-center w-1/3 h-4 p-5 rounded-xl bg-${priceColor}-100 text-${priceColor}-600`}
      >
